export default {
  ...
  water_guide: {
    ...
    save: 'Save',
    cancel: 'Cancel',
    save_error: 'Could not save your water profile. Please try again.',
  ...
  settings: {
    ...
    export_error: 'Could not export your backup right now.',
    ...
    db_browser_title: 'Database browser',
    db_browser_desc: 'Open the SQLite admin GUI for advanced database operations.',
    db_browser_open: 'Open',
    logout_btn: 'Log out',
  },
  db_browser: {
    title: 'Database Browser',
    subtitle: 'SQLite GUI powered by sqlite-gui-node',
    back: 'Back',
    access: 'Admin access',
    secret_label: 'Admin secret',
    secret_placeholder: 'Paste ADMIN_SECRET',
    secret_required: 'Admin secret is required.',
    remember_secret: 'Remember secret on this device',
    open_gui: 'Open GUI',
    warning:
      'This is a full database admin tool with write capabilities. Use it carefully in trusted environments only.',
    generic_error: 'Could not load database data right now.',
  },
  login: {
