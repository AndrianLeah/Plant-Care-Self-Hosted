export default {
  ...
  settings: {
    ...
    db_browser_title: 'Browser database',
    db_browser_desc: 'Apri la GUI admin SQLite per operazioni avanzate sul database.',
    db_browser_open: 'Apri',
    logout_btn: 'Esci',
  },
  db_browser: {
    title: 'Browser Database',
    subtitle: 'Interfaccia SQLite basata su sqlite-gui-node',
    back: 'Indietro',
    access: 'Accesso admin',
    secret_label: 'Secret admin',
    secret_placeholder: 'Incolla ADMIN_SECRET',
    secret_required: 'Il secret admin è obbligatorio.',
    remember_secret: 'Ricorda il secret su questo dispositivo',
    open_gui: 'Apri GUI',
    warning:
      'Questo strumento amministra l’intero database e permette modifiche. Usalo con cautela solo in ambienti fidati.',
    generic_error: 'Impossibile caricare i dati del database ora.',
  },
  login: {
